...
<body onLoad="focusIt();" bgcolor="${bodyback_c}">
  <table width=500 cellpadding="0" cellspacing="0"  align="center" border="1" >
      <tr>
       ...
       <form name="inform" method="post" action="/mvc/user/loginPro.me"  onSubmit="return checkIt();">
      ...
      <tr > 
       ...
       <tr>
          <td colspan="3" bgcolor="${title_c}"   align="center">
            ...
            <input type="button"  value="회원가입" onclick="javascript:window.location='/mvc/user/inputForm.me'"> 
          </td></form></tr></table>
       ...
       <table width=500 cellpadding="0" cellspacing="0"  align="center" border="1" >
         <tr>
           ...
           <td rowspan="3" bgcolor="${value_c}" align="center">
             ...
             방문하셨습니다
             <form  method="post" action="/mvc/user/logout.me">  
             <input type="submit"  value="로그아웃">
             <input type="button" value="회원정보변경" onclick="javascript:window.location='/mvc/user/modify.me'">
             <input type="button" value="게시판가기" onclick="javascript:window.location='/mvc/board/list.bo'">
             </form>
         </td>
        </tr>
       <tr > 
