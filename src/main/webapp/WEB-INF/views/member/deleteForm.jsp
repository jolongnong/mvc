...
<form name="myform" action="/mvc/user/deletePro.me" method="post" onSubmit="return checkIt()">
<TABLE cellSpacing=1 cellPadding=1 width="260" border=1 align="center" >
  ...
  <TR height="30">
    <TD colspan="2" align="middle" bgcolor="${title_c}" >
      ...
      <input type="button" value="취  소" onclick="javascript:window.location='/mvc/user/main.me'"></TD></TR>
</TABLE>
</form>
</BODY>
</HTML>
